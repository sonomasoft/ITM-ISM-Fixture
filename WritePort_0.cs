...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("WriteDig1DU32", MxbFile="WritePort_0.mxb")]
    partial class WritePort_0Component : FiniteOutputDaqComponent<DigitalMultiChannelWriter, uint[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public WritePort_0Component()
        {
            Initialize();
        }
        ...
        /// </summary>
        public WritePort_0Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class WritePort_0Component
    {
        /// <summary>
        ...
        public event EventHandler<WritePort_0ComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class WritePort_0ComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public WritePort_0ComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class WritePort_0 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DOChannel ch = DOChannels.CreateChannel("NI-USB-6501/port0", "DigitalOut", ChannelLineGrouping.OneChannelForAllLines);
