...
namespace ITM_ISM_Fixture
{
    ...
    /// </summary>    
    public sealed class BK1685BGETDResults
    {
    ...
    public sealed class BK1685BGETD : IDisposable
    {
        ...
        /// </summary>
        public BK1685BGETD() : this(DefaultSessionName)
        {
        }
        ...
        public BK1685BGETD(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public BK1685BGETD(MessageBasedSession session) : this(session, false)
        {
        }
        ...
        public BK1685BGETD(MessageBasedSession session, bool taskHandlesSessionLifetime)
        {
            if (session == null)
        ...
        /// </summary>
        public BK1685BGETDResults Run( )
        {
            if (_instrumentSession == null)
                throw new ArgumentNullException("_instrumentSession");
        
            BK1685BGETDResults outputs = new BK1685BGETDResults();
