...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="Thermistor_OFF.mxb")]
    partial class Thermistor_OFFComponent : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public Thermistor_OFFComponent()
        {
            Initialize();
        }
        ...
        /// </summary>
        public Thermistor_OFFComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class Thermistor_OFFComponent
    {
        /// <summary>
        ...
        public event EventHandler<Thermistor_OFFComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class Thermistor_OFFComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public Thermistor_OFFComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class Thermistor_OFF : Task
    {
        public Thermistor_OFF()
        {
            Configure();
        }
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DOChannel ch = DOChannels.CreateChannel("NI-USB-6501/port1/line7", "DigitalOut", ChannelLineGrouping.OneChannelForEachLine);
                
                DOChannels["DigitalOut"].OutputDriveType = DOOutputDriveType.OpenCollector;
