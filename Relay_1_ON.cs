...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("WriteDig1DU32", MxbFile="Relay_1_ON.mxb")]
    partial class Relay_1_ONComponent : FiniteOutputDaqComponent<DigitalMultiChannelWriter, uint[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public Relay_1_ONComponent()
        {
            Initialize();
        }
        ...
        /// </summary>
        public Relay_1_ONComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class Relay_1_ONComponent
    {
        /// <summary>
        ...
        public event EventHandler<Relay_1_ONComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class Relay_1_ONComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public Relay_1_ONComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
