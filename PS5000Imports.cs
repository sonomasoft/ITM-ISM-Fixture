...
namespace ITM_ISM_Fixture
{
    class Imports
    {
        ...
        public enum ArbWaveFormSize : int  // just set to the value we are using (32767)
        {
        ...
        public static extern short SetSigGenPropertiesArbitrary
            (
            short handle,
            uint startDeltaPhase,
            uint stopDeltaPhase,
        ...
        public static extern short SigGenSoftwareControl
        (
