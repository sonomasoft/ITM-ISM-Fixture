...
namespace ITM_ISM_Fixture
{
    ...
    public sealed class BK2831E_SetVoltage : IDisposable
    {
        ...
        /// </summary>
        public BK2831E_SetVoltage() : this(DefaultSessionName)
        {
        }
        ...
        public BK2831E_SetVoltage(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public BK2831E_SetVoltage(MessageBasedSession session) : this(session, false)
        {
        }
        ...
        public BK2831E_SetVoltage(MessageBasedSession session, bool taskHandlesSessionLifetime)
        {
            if (session == null)
