...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="ChargeOff.mxb")]
    partial class ChargeOffComponent : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public ChargeOffComponent()
        {
            Initialize();
        }
        ...
        /// </summary>
        public ChargeOffComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class ChargeOffComponent
    {
        /// <summary>
        ...
        public event EventHandler<ChargeOffComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class ChargeOffComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public ChargeOffComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class ChargeOff : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DOChannel ch = DOChannels.CreateChannel("NI-USB-6501/port1/line6", "DigitalOut", ChannelLineGrouping.OneChannelForEachLine);
