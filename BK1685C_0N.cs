...
namespace ITM_ISM_Fixture
{
    ...
    public sealed class BK1685C_0N : IDisposable
    {
        ...
        /// </summary>
        public BK1685C_0N() : this(DefaultSessionName)
        {
        }
        ...
        public BK1685C_0N(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public BK1685C_0N(MessageBasedSession session) : this(session, false)
        {
        }
        ...
        public BK1685C_0N(MessageBasedSession session, bool taskHandlesSessionLifetime)
        {
            if (session == null)
