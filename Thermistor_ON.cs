...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="Thermistor_ON.mxb")]
    partial class Thermistor_ONComponent : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public Thermistor_ONComponent()
        {
            Initialize();
        }
        ...
        /// </summary>
        public Thermistor_ONComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class Thermistor_ONComponent
    {
        /// <summary>
        ...
        public event EventHandler<Thermistor_ONComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class Thermistor_ONComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public Thermistor_ONComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class Thermistor_ON : Task
    {
        public Thermistor_ON()
        {
            Configure();
        }
