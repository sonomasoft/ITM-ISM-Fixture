...
namespace ITM_ISM_Fixture
{
    ...
    public sealed class BK2831E_SetCurrent : IDisposable
    {
        ...
        /// </summary>
        public BK2831E_SetCurrent() : this(DefaultSessionName)
        {
        }
        ...
        public BK2831E_SetCurrent(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public BK2831E_SetCurrent(MessageBasedSession session) : this(session, false)
        {
        }
        ...
        public BK2831E_SetCurrent(MessageBasedSession session, bool taskHandlesSessionLifetime)
        {
            if (session == null)
