...
namespace ITM_ISM_Fixture
{
    ...
    public sealed class SetChannel_D : IDisposable
    {
        ...
        /// </summary>
        public SetChannel_D() : this(DefaultSessionName)
        {
        }
        ...
        public SetChannel_D(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public SetChannel_D(MessageBasedSession session) : this(session, false)
        {
        }
        ...
        public SetChannel_D(MessageBasedSession session, bool taskHandlesSessionLifetime)
        {
            if (session == null)
