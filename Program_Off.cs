...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="Program_Off.mxb")]
    partial class Program_OffComponent : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public Program_OffComponent()
        {
            Initialize();
        }
        ...
        /// </summary>
        public Program_OffComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class Program_OffComponent
    {
        /// <summary>
        ...
        public event EventHandler<Program_OffComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class Program_OffComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public Program_OffComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class Program_Off : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DOChannel ch = DOChannels.CreateChannel("NI-USB-6501/port1/line5", "DigitalOut", ChannelLineGrouping.OneChannelForEachLine);
