...
namespace ITM_ISM_Fixture
{
    ...
    public sealed class SetChannel_B : IDisposable
    {
        ...
        /// </summary>
        public SetChannel_B() : this(DefaultSessionName)
        {
        }
        ...
        public SetChannel_B(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public SetChannel_B(MessageBasedSession session) : this(session, false)
        {
        }
