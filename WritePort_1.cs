...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("WriteDig1DU32", MxbFile="WritePort_1.mxb")]
    partial class WritePort_1Component : FiniteOutputDaqComponent<DigitalMultiChannelWriter, uint[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public WritePort_1Component()
        {
            Initialize();
        }
        ...
        /// </summary>
        public WritePort_1Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class WritePort_1Component
    {
        /// <summary>
        ...
        public event EventHandler<WritePort_1ComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class WritePort_1ComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public WritePort_1ComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class WritePort_1 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DOChannel ch = DOChannels.CreateChannel("NI-USB-6501/port1", "DigitalOut", ChannelLineGrouping.OneChannelForAllLines);
