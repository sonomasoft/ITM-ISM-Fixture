...
namespace ITM_ISM_Fixture
{
    ...
    public sealed class SetChannel_E : IDisposable
    {
        ...
        /// </summary>
        public SetChannel_E() : this(DefaultSessionName)
        {
        }
        ...
        public SetChannel_E(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public SetChannel_E(MessageBasedSession session) : this(session, false)
        {
        }
        ...
        public SetChannel_E(MessageBasedSession session, bool taskHandlesSessionLifetime)
        {
            if (session == null)
