...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="Program_ON.mxb")]
    partial class Program_ONComponent : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public Program_ONComponent()
        {
            Initialize();
        }
        ...
        /// </summary>
        public Program_ONComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class Program_ONComponent
    {
        /// <summary>
        ...
        public event EventHandler<Program_ONComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class Program_ONComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public Program_ONComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
