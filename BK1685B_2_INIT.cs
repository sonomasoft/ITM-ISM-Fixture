...
namespace ITM_ISM_Fixture
{
    ...
    public sealed class BK1685B_2_INIT : IDisposable
    {
        ...
        /// </summary>
        public BK1685B_2_INIT() : this(DefaultSessionName)
        {
        }
        ...
        public BK1685B_2_INIT(string sessionName) : this (OpenSession(sessionName), true)
        {
        }
        ...
        public BK1685B_2_INIT(MessageBasedSession session) : this(session, false)
        {
        }
        ...
        public BK1685B_2_INIT(MessageBasedSession session, bool taskHandlesSessionLifetime)
        {
            if (session == null)
