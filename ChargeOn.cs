...
namespace ITM_ISM_Fixture
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="ChargeOn.mxb")]
    partial class ChargeOnComponent : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public ChargeOnComponent()
        {
            Initialize();
        }
        ...
        /// </summary>
        public ChargeOnComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
    ...
    partial class ChargeOnComponent
    {
        /// <summary>
        ...
        public event EventHandler<ChargeOnComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class ChargeOnComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public ChargeOnComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
